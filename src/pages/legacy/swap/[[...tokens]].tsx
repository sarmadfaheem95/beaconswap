...
import { Currency, JSBI, Token, Trade as V2Trade, TradeType } from 'beaconswap-core-sdk'
        ...
        <div className="flex flex-col gap-3">
          ...
          {swapIsUnsupported ? (
            ...
            <Web3Connect
              variant="outlined"
              fullWidth
              className="bg-gradient-to-r from-pink/95 hover:from-pink to-red/95 hover:to-red text-dark "
            />
          ) : showWrap ? (
            <Button
              fullWidth
