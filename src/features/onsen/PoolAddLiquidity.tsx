...
import { ChainId, CurrencyAmount, currencyEquals, NATIVE, WNATIVE } from 'beaconswap-core-sdk'
      ...
      <HeadlessUiModal.BorderedContent className="flex flex-col gap-4 bg-dark-1000/40">
        ...
        {(oneCurrencyIsETH || oneCurrencyIsWETH) && chainId != ChainId.CELO && (
          <div className="flex justify-center">
            <Button size="xs" variant="outlined" color="pink" className="rounded-none" onClick={() => setUseETH(!useETH)}>
